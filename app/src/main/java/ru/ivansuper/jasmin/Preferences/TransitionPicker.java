...
public class TransitionPicker extends DialogPreference {
    ...
    protected void onBindDialogView(View view) {
        ...
        r.setOnClickListener(view1 -> TransitionPicker.this.current = 0);
        rg.addView(r);
        if (this.current == 0) {
            r.setChecked(true);
        }
        ...
        r2.setOnClickListener(arg0 -> TransitionPicker.this.current = 1);
        rg.addView(r2);
        if (this.current == 1) {
            r2.setChecked(true);
        }
        ...
        r3.setOnClickListener(arg0 -> TransitionPicker.this.current = 2);
        rg.addView(r3);
        if (this.current == 2) {
            r3.setChecked(true);
        }
        ...
        r4.setOnClickListener(arg0 -> TransitionPicker.this.current = 3);
        rg.addView(r4);
        if (this.current == 3) {
            r4.setChecked(true);
        }
        ...
        r5.setOnClickListener(arg0 -> TransitionPicker.this.current = 4);
        rg.addView(r5);
        if (this.current == 4) {
            r5.setChecked(true);
        }
        ...
        r6.setOnClickListener(arg0 -> TransitionPicker.this.current = 5);
        rg.addView(r6);
        if (this.current == 5) {
            r6.setChecked(true);
        }
        ...
        r7.setOnClickListener(arg0 -> TransitionPicker.this.current = 6);
        rg.addView(r7);
        if (this.current == 6) {
            r7.setChecked(true);
        }
        ...
        r8.setOnClickListener(arg0 -> TransitionPicker.this.current = 7);
        rg.addView(r8);
        if (this.current == 7) {
            r8.setChecked(true);
        }
        ...
        r9.setOnClickListener(arg0 -> TransitionPicker.this.current = 10);
        rg.addView(r9);
        if (this.current == 10) {
            r9.setChecked(true);
        }
        ...
        r10.setOnClickListener(arg0 -> TransitionPicker.this.current = 8);
        rg.addView(r10);
        if (this.current == 8) {
            r10.setChecked(true);
        }
        ...
        r11.setOnClickListener(arg0 -> TransitionPicker.this.current = 9);
        rg.addView(r11);
        if (this.current == 9) {
            r11.setChecked(true);
        }
        ...
        r12.setOnClickListener(arg0 -> TransitionPicker.this.current = -1);
        rg.addView(r12);
        if (this.current == -1) {
            r12.setChecked(true);
        }
